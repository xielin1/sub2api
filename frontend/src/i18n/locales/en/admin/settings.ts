export default {
    settings: {
      ...
      site: {
        ...
        contactDialog: {
          enabled: 'Navbar "Contact us" button',
          enabledHint: 'Shows a button next to "Docs" in the top navbar that opens the dialog configured below; empty fields are hidden',
          title: 'Button text / dialog title',
          titlePlaceholder: 'Contact us',
          sectionTitle: 'Section title',
          sectionTitlePlaceholder: 'Official community group',
          sectionSubtitle: 'Section subtitle',
          sectionSubtitlePlaceholder: 'Important notices and service updates are posted in the group',
          cardTitle: 'Card title',
          cardTitlePlaceholder: 'QQ group',
          badgeText: 'Card badge',
          badgeTextPlaceholder: 'Open',
          scanTitle: 'Scan title',
          scanTitlePlaceholder: 'Scan with mobile QQ',
          scanHint: 'Scan hint',
          scanHintPlaceholder: 'Scan the QR code to request to join the group',
          groupNumber: 'Group number',
          groupNumberPlaceholder: '663638744',
          copyButtonText: 'Copy button text',
          copyButtonTextPlaceholder: 'Copy QQ group number',
          footerText: 'Footer hint',
          footerTextPlaceholder: 'If you run into problems, check the group announcements or ask support.',
          qrCode: 'QR code image',
          qrCodeHint: 'PNG or JPG, max 300KB.',
        },
