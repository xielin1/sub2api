export default {
    settings: {
      ...
      site: {
        ...
        contactDialog: {
          enabled: '导航栏「联系我们」按钮',
          enabledHint: '开启后在顶部导航栏「文档」旁显示按钮，点击弹出下方配置的内容；留空的字段不展示',
          title: '按钮文字 / 弹窗标题',
          titlePlaceholder: '联系我们',
          sectionTitle: '小节标题',
          sectionTitlePlaceholder: '官方交流群',
          sectionSubtitle: '小节副标题',
          sectionSubtitlePlaceholder: '重要通知与服务动态将在群内发布',
          cardTitle: '卡片标题',
          cardTitlePlaceholder: 'QQ群',
          badgeText: '卡片标记',
          badgeTextPlaceholder: '可加入',
          scanTitle: '扫码标题',
          scanTitlePlaceholder: '手机 QQ 扫一扫',
          scanHint: '扫码说明',
          scanHintPlaceholder: '扫描二维码，申请加入官方交流群',
          groupNumber: '群号',
          groupNumberPlaceholder: '663638744',
          copyButtonText: '复制按钮文字',
          copyButtonTextPlaceholder: '复制 QQ 群号',
          footerText: '底部提示',
          footerTextPlaceholder: '遇到问题时，可以先在群内查看公告或咨询客服。',
          qrCode: '二维码图片',
          qrCodeHint: 'PNG 或 JPG 格式，最大 300KB。',
        },
        contactInfo: '客服联系方式',
